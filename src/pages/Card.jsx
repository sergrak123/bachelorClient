...
export default function Card({open, setOpen, productUnit}) {
                                ...
                                <div
                                    ...
                                    <div className="sm:col-span-4 lg:col-span-5">
                                        <div className="aspect-w-1 aspect-h-1 rounded-lg bg-gray-100 overflow-hidden">
                                            <img src={productUnit.photoUrl} alt={product.imageAlt}
                                    ...
                                    <div className="sm:col-span-8 lg:col-span-7">
                                        <h2 className="text-2xl font-montserrat font-semibold text-gray-900 sm:pr-12">{productUnit.name}</h2>
                                        ...
                                        <section aria-labelledby="options-heading" className="mt-6">
                                            ...
                                            <form>
                                                ...
                                                <div className="mt-6">
                                                    <button
                                                        type="submit"
                                                        className="w-full bg-green-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500"
                                                    >
                                                        Добавить в корзину
                                                    </button>
                                                </div>
